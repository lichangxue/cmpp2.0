...
ccCellWindow.prototype.inputScript = function(type,tpl){
	...
	var url = "/main/pageContent.html?id=34&nodeid=" + globalvars.nodeId + "&id1="+ globalvars.id +"&id2=" + this.cell.objectIdentity + "&stype="+ type +"&tpl="+tpl+"&scope=wf&language=javascript"
	if(top && top.openTab){
